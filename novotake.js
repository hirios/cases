...
function setEmails(email1, email2) {
    ...
    if (!emailsFields[0].innerText.includes('@')) {
        emailTo.focus()
        emailTo.value = email1
        document.execCommand('insertText', false, ' ')
    }


    if (!emailsFields[1].innerText.includes('@')) {
        emailCC.focus()
        emailCC.value = email2
        document.execCommand('insertText', false, ' ')
    }
}
